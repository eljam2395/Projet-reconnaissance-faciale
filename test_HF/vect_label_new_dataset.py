...
img_path='frontalimages_spatiallynormalized_cropped_equalized_part1/'
...
vect_img=np.reshape(tab_img,[400,193*162])

np.save('Img_flatten_cropped',vect_img)
